...
This list of radars in the Next Generation Weather Radar (NEXRAD) system is derived from two **files maintained by NOAA** for their [radar map](https://www.weather.gov/nl2/NEXRADView). Issues can be reported to [Alex Tedeschi](mailto:alexander.tedeschi@cornell.edu).
